...
extern void (*mock_iolink_al_write_cnf_cb)(iolink_port_t * port,
                                           iolink_smi_errortypes_t errortype);
extern void (*mock_iolink_al_read_cnf_cb)(iolink_port_t * port, uint8_t len,
                                          uint8_t * data,
                                          iolink_smi_errortypes_t errortype);
...
iolink_error_t mock_DL_PDOutputUpdate_req (iolink_port_t * port, uint8_t len,
                                           uint8_t *outputdata);
iolink_error_t mock_DL_PDOutputUpdate (iolink_port_t * port, uint8_t len,
                                       uint8_t *outputdata);
...
iolink_error_t mock_AL_Write_req (iolink_port_t * port, uint16_t index,
                        ...
                        void (*al_write_cb)(iolink_port_t * port,
                                            iolink_smi_errortypes_t errortype));
void mock_AL_Write_cnf (iolink_port_t * port,
                        iolink_smi_errortypes_t errortype);
