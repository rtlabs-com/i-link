...
void spi_transfer(int fd, void * data_read, const void * data_written, size_t n_bytes_to_transfer)
{
   // TODO
   int delay = 100;
...
#define SPI_TRANSFER(fd, rbuf, wbuf, size) \
   spi_transfer(fd, rbuf, wbuf, size);
#endif
...
static void iolink_pl_max14819_pl_handler (iolink_hw_drv_t * iolink_hw,
                                           void * arg);

static void iolink_14819_write_register (iolink_14819_drv_t * iolink,
...
static uint8_t iolink_14819_read_register (iolink_14819_drv_t * iolink,
                                           uint8_t reg)
{
   uint8_t wbuf[2];
   uint8_t rbuf[2];
...
static void iolink_14819_burst_write_tx (iolink_14819_drv_t * iolink,
...
static uint8_t iolink_14819_burst_read_rx (iolink_14819_drv_t * iolink,
                                        iolink_14819_channel_t ch,
                                        uint8_t *data, uint8_t rxbytes)
{
   uint8_t rxtxreg = REG_TxRxDataA + ch;
...
static void iolink_14819_set_DO (iolink_14819_drv_t * iolink,
                                 iolink_14819_channel_t ch,
                                 iolink_14819_cq_cfg_t * cfg)
{
   ...
   iolink_14819_write_register (iolink, REG_InterruptEn,
                                regval & ~(0x05 << ch));
   ...
   iolink_14819_write_register (iolink, REG_CQCfgA + ch,
                                cfg->DO.cq_conf_val & 0x0C);
   iolink_14819_write_register (iolink, REG_TrigAssgnA + ch, 0x00);
   iolink->is_iolink[ch] = false;
   iolink->wurq_request[ch] = false;
}

static void iolink_14819_set_DI (iolink_14819_drv_t * iolink,
                                 iolink_14819_channel_t ch,
                                 iolink_14819_cq_cfg_t * cfg)
{
   uint8_t regval;
...
static void iolink_14819_set_SDCI (iolink_14819_drv_t * iolink,
                                   iolink_14819_channel_t ch,
                                   iolink_14819_cq_cfg_t * cfg)
{
   uint8_t regval;
   ...
   iolink_14819_write_register (iolink, REG_CQCtrlA + ch,
                                cfg->SDCI.cq_ctrl_val);
   iolink_14819_write_register (iolink, REG_MsgCtrlA + ch,
                                cfg->SDCI.msg_ctrl_val);
   iolink_14819_write_register (iolink, REG_ChanStatA + ch,
                                cfg->SDCI.chan_stat_val);
   iolink_14819_write_register (iolink, REG_CyclTmrA + ch,
                                cfg->SDCI.cycl_tmr_val);
   iolink_14819_write_register (iolink, REG_DeviceDlyA + ch,
                                cfg->SDCI.dev_del_val);
   iolink_14819_write_register (iolink, REG_TrigAssgnA + ch,
...
static void iolink_14819_send_master_message (iolink_14819_drv_t * iolink,
                                              iolink_14819_channel_t ch)
{
   uint8_t reg_val;
...
static void iolink_14819_delete_master_message (iolink_14819_drv_t * iolink,
                                               iolink_14819_channel_t ch)
{
...
static void iolink_14819_set_master_message (iolink_14819_drv_t * iolink,
                                             iolink_14819_channel_t ch,
                                             uint8_t *data, uint8_t txlen,
                                             uint8_t rxlen, bool keepmessage)
{
...
static iolink_baudrate_t iolink_pl_max14819_get_baudrate (iolink_hw_drv_t * iolink_hw,
                                                          void * arg)
{
...
static uint8_t iolink_pl_max14819_get_cycletime (iolink_hw_drv_t * iolink_hw,
                                                 void * arg)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static void iolink_pl_max14819_set_cycletime (iolink_hw_drv_t * iolink_hw,
                                              void * arg, uint8_t cycbyte)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static bool iolink_pl_max14819_set_mode (iolink_hw_drv_t * iolink_hw,
                                         void * arg, iolink_pl_mode_t mode)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
   ...
   case iolink_mode_SDCI:
      ...
      iol_cfg.SDCI.msg_ctrl_val = 0x26; /* InsChks = 1, RChksEn = 1, RMessageRdyEn = 1 */
...
static void iolink_pl_max14819_configure_event (iolink_hw_drv_t * iolink_hw,
                                                void * arg,
                                                os_event_t * event,
                                                uint32_t flag)
{
...
static void iolink_pl_max14819_enable_cycle_timer (iolink_hw_drv_t * iolink_hw,
                                                   void * arg)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static void iolink_pl_max14819_disable_cycle_timer (iolink_hw_drv_t * iolink_hw,
                                                    void * arg)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static void iolink_pl_max14819_get_error (iolink_hw_drv_t * iolink_hw,
                                          void * arg, uint8_t *cqerr,
                                          uint8_t *devdly)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static void iolink_pl_max14819_get_data (iolink_hw_drv_t * iolink_hw,
                                          void * arg, uint8_t *rxdata,
                                          uint8_t len)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
   ...
   {
      LOG_DEBUG (IOLINK_PL_LOG, "%s: Rxbytes in LVL-reg (%d) does not match bytes in RX-reg (%d)\n",
                 __func__, rxbytes, RxBytesAct);
   }

   if (len < rxbytes)
   {
      LOG_ERROR (IOLINK_PL_LOG, "%s: Read buffer too small. Needed size: %d. Actual size: %d",
                 __func__, rxbytes, len);
      rxbytes = len;
   }
...
static void iolink_pl_max14819_send_msg (iolink_hw_drv_t * iolink_hw,
                                         void * arg)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
...
static void iolink_pl_max14819_dl_msg (iolink_hw_drv_t * iolink_hw,
                                       void * arg, uint8_t rxbytes,
...
static void iolink_pl_max14819_transfer_req (iolink_hw_drv_t * iolink_hw,
                                             void * arg, uint8_t rxbytes,
                                             uint8_t txbytes, uint8_t *data)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
...
static bool iolink_pl_max14819_init_sdci (iolink_hw_drv_t * iolink_hw,
                                          void * arg)
{
   iolink_14819_drv_t * iolink = (iolink_14819_drv_t *)iolink_hw;
   iolink_14819_channel_t ch = (iolink_14819_channel_t)arg;
                                           ...
                                           void * arg)
{
   ...
   if (reg & MAX14819_INTERRUPT_WURQ)
   {
      ...
      if (!completed_wurq)
      {
         ...
         LOG_ERROR (IOLINK_PL_LOG,
                    "PL: Got WURQ, but no channel was handled\n");
      }
   }
...
#ifdef __rtk__
static int iolink_pl_max14819_open (drv_t * drv, const char * name, int flags,
                                    int mode)
{
   const char * p = name;
